...
SECRET_KEY = 'u7u7zl5c=3r=4*+_wt6t)e$_6mh201=!om_cc@p6iv(&g%nf(v'
...
# atribuindo tradução para PT-BR
LANGUAGE_CODE = 'pt-br'
...
#caminho de upload de arquivos de imagens utilizando BASE_DIR como diretorio base
